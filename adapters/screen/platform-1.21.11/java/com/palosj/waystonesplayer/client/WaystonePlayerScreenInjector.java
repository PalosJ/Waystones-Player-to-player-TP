...
public final class WaystonePlayerScreenInjector {
    ...
    private static List<PlayerInfo> getOnlinePlayers() {
        ...
        List<PlayerInfo> players = new ArrayList<>(minecraft.getConnection().getListedOnlinePlayers());
        players.removeIf(info -> PlayerProfileCompat.id(info).equals(minecraft.player.getUUID()));
