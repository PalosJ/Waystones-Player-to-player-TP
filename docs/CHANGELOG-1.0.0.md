...
- Routes player destinations through Waystones events, sound, effects, and native destination placement.
- Revalidates the exact Warp Stone, hand, online target UUID, cost, and confirmed movement on the server.
...
Player destinations do not guarantee solid ground or exclude blocks, dangerous fluids, and cliffs.
