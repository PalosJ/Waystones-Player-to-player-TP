...
- Fixes 26.1.2/26.2 player-panel overlap with native manage/group buttons by reserving their actual left extent and the container right edge, including narrow windows.
...
Ongoing maintenance covers eight artifacts: NeoForge and Fabric for 1.21.1, 1.21.11, 26.1.2, and 26.2. Other versions no longer receive updates. NeoForge 1.21.1 remains the canonical main branch. Complete gameplay acceptance remains separate: see [VALIDATION.md](VALIDATION.md).
