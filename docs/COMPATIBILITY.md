...
| 26.1.2 | 26.1.2.1 / 26.1.2.14 | 26.1.1.2 / 26.1.2.12 | 26.1.0.1 / 26.1.2.8 | 26.1.2.0-beta / 26.1.2.97 | 0.19.1 / 0.145.4；0.19.3 / 0.155.2 |
| 26.2 | 26.2.0.1 / 26.2.0.9 | 26.2.0.1 / 26.2.0.6 | 26.2.0.1 / 26.2.0.5 | 26.2.0.0-beta / 26.2.0.66 | 0.19.3 / 0.152.1；0.19.3 / 0.158.0 |
...
总计 28 个可上传 JAR，全部版本号 `1.0.1`。除明确共享的 1.21.2/1.21.3 外，每份元数据只接受一个 Minecraft 小版本。
