...
|---|---|---|---|---|---|
| 26.1 | Fabric 26.1.0.1，NeoForge 26.1.0.4 / 26.1.0.4 | 26.1.0.1 / 26.1.0.6 | 26.1.0.1 / 26.1.0.1 | 26.1.0.1-beta / 26.1.0.19-beta | 0.18.4 / 0.144.0；0.19.3 / 0.145.1 |
...
Runtime 门禁还排除了几组版本名看似匹配、实际不能启动的组合：NeoForge Waystones `26.1.0.1` 会在专用服务器加载客户端类；Balm `26.1.1.1` 要求 NeoForge 至少 `26.1.1.8-beta`且 Fabric API 至少 `0.145.4+26.1.1`；Minecraft 26.1.2 不能用仅启动 26.1.1 的 NeoForge `26.1.1.15-beta`。矩阵使用上表经运行日志确认的下限，不将这些失败组合宣称为支持。
